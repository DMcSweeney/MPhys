...
def train():
    ...
    x1 = Conv3D(64, (3, 3, 3), activation='relu', padding='same', name='down_1')(x1)
    ...
    x2 = Conv3D(128, (3, 3, 3), activation='relu', padding='same', name='down_2')(x2)
    ...
    x3 = Conv3D(256, (3, 3, 3), activation='relu', padding='same', name='down_3')(x3)
    x3 = BatchNormalization()(x3)

    x = UpSampling3D(size=(2, 2, 2), name='UpSamp_3')(x3)
    y2 = Conv3DTranspose(128, (3, 3, 3), activation='relu', padding='same', name='Up_2')(x)
    y2 = Conv3DTranspose(128, (3, 3, 3), activation='relu', padding='same', name='Up_2')(y2)
    ...
    y1 = Conv3DTranspose(64, (3, 3, 3), activation='relu', padding='same', name='Up_1')(y1)
