...
def infer(batch_size=2):
    ...
    for i in range(23):
        ...
        myPredictGen = gen.evaluate_generator(
            normalised_dataset, list_avail_keys, hamming_set, hamming_idx=idx_list, batch_size=batch_size, blank_idx=blank_idx, full_crop=True, out_crop=False, inner_crop=False, N=10)
